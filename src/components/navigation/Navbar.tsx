...
import { Search, User, Settings, LogOut, Play, Menu, X, Shield, Users } from 'lucide-react';
              ...
              {user ? (
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <button
                    ...
                    className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-6 py-2 rounded-xl text-sm font-medium transition-all duration-300 transform hover:scale-105"
                  >
                    Sign Up
                  </button>
                </div>
              ...
              {navigation.map((item) => (
                <Link
                  ...
                  className={`block px-4 py-3 rounded-xl text-base font-medium transition-all ${
                    isActive(item.href)
                      ? 'text-white bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-500/30 mx-2'
              ...
              {!user && (
                <div className="mt-4 px-2 space-y-2">
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-4 py-3 rounded-xl text-base font-medium transition-all duration-300"
                  >
                    Sign Up
                  </button>
                </div>
